...
(function() {
  var Option, bulldata, calculateShippingCosts, callEbay, createEbayHTML, createError, ebay, getBulls, getCows, getEbay, kvigedata, postCow, restify, server;
  ...
  calculateShippingCosts = function(items, callback) {
    ...
    for (_i = 0, _len = items.length; _i < _len; _i++) {
      ...
      callEbay(option, function(error, item) {
